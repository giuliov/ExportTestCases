...
namespace TestCaseExport
{
    ...
    ///     Biggest issue here comes from the mismatch of API styles.  HTML is a tree.  Rich text is a stream with format
    ///     changes able to be made at the beginning of each block.
    ///     However, you *cannot* change the format without emtting a text block.
    ///     Basically, we do a depth-first traversal, queueing changes as we go down, and queuing the reverse of our changes as
    ///     we work our way back up.
    /// </summary>
    public class HtmlToRichTextHelper
    {
        ...
        /// <summary>
        ///     Simple implementation of IRichTextModifier to set a specific value when Apply is called, and restore the original
        ///     value when Undo is.
        /// </summary>
